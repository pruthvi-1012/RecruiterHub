...
<table width="1403" height="1053" border="1">
  ...
  <tr>
    ...
    <p align="center" class="style1"> 
     <p align="center" style="color:#0000FF;font-size:36px"> INTERVIEW SCHEDULE</p>
    
        
        <s:form action="interview.action">
<s:textfield name="vac_id" label="VACANCY NO."></s:textfield>
<s:datetimepicker name="interview_date" label="DATE OF INTERVIEW"></s:datetimepicker>
<s:textfield name="interview_time" label="TIME OF INTERVIEW"/>
<s:textfield name="interview_place" label="PLACE OF INTERVIEW"></s:textfield>
<s:select list="{'HR','Technical'}" name="interview_department" label="INTERVIEW DEPARTMENT"></s:select>
<s:textfield name="interviewer_name" label="INTERVIEWER NAME"></s:textfield>

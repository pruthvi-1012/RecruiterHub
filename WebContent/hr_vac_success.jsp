...
<table width="1403" height="1053" border="1">
  ...
  <tr>
    ...
    <p align="center" class="style1"> 
      ...
      <p align="center" style="color:#0000FF;font-size:24px"> Vacancy has been Successfully Created</p>
    <table width="504" height="217" border="0">
  <tr>

  <tr>
    <td align="center"><s:form action="hr_vac_details.action"><s:submit value="Vacancy Details"></s:submit> </s:form> </td>
  </tr>
  <tr>

  </tr>
  <tr>
  <s:form action="hr_home.action"><s:submit value="Home"></s:submit> </s:form>
  <tr>

...
<table width="1403" height="1053" border="1">
  ...
  <tr>
    ...
    <p align="center" style="color:#0000FF;font-size:24px"> Click Here.....</p>
    <p align="center" style="color:#0000FF;font-size:24px"> To view applicant details</p>
    
    <table width="504" height="217" border="0" cellspacing="2">
  <tr>
   <s:form action="hr_applicant_details.action">
   <s:submit value="Applicant Details" align="centre"></s:submit>
   </s:form>
  </tr>
</table>

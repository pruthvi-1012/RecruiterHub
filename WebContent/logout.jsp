...
<table width="1403" height="1053" border="1">
  ...
  <tr>
    ...
    <p align="center" style="color:#0000FF;font-size:24px"> You are successfully log out........</p>
    
    
     <p align="center" style="color:#0000FF;font-size:24px"> To login again click here......</p>
     <p align="center" style="color:#0000FF;font-size:24px"><a href="login.jsp">Login</a>  </p>

...
<table width="1403" height="1053" border="1">
  ...
  <tr>
    ...
    <p align="center" class="style1"> 
      ...
      <p align="center" style="color:#0000FF;font-size:24px"> Vacancy Management</p>
    <table width="504" height="217" border="0">
  <tr>
  
    <td align="center"><s:form action="hr_vac_create.action"><s:submit value="Create Vacancy"></s:submit> </s:form> </td>
  </tr>
  <tr>
    <td align="center"><s:form action="hrvacancyshow.action"><s:submit value="View Vacancy"></s:submit> </s:form> </td>
  </tr>
  <tr>
    <td align="center"><s:form action="hr_vac_edit.action"><s:submit value="Edit/Delete Vacancy"></s:submit> </s:form> </td>
  </tr>
</table>

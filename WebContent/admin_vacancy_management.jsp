...
<table width="1403" height="1053" border="1">
  ...
  <tr>
    ...
    <p align="center" style="color:#0000FF;font-size:24px"> WelCome!!!!!!!!</p>
    <p align="center" style="color:#0000FF;font-size:24px"> You are logged in successfully</p>
    
    <table width="504" height="217" border="0" cellspacing="2">
  <tr>
    
    <td> <s:form action="adminvacancyshow.action"><s:submit value="Vacancy Details"></s:submit> </s:form> </td>
  </tr>
  <tr>
    
     <td> <s:form action="adminvacancyedit.action"><s:submit value="Vacancy Edit/Delete"></s:submit> </s:form> </td>
  </tr>
</table>

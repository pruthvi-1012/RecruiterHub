...
<table width="1403" height="1053" border="1">
  ...
  <tr>
    ...
    <p>&nbsp;</p>
    <p>&nbsp;</p>
    <table width="286" height="246" border="1">
      <tr>
    ...
    <p align="center" style="color:#0000FF;font-size:24px"> You have Successfully Applied to Vacancy</p>
    <p align="center" style="color:#0000FF;font-size:24px"> Click Here to go your home page</p>
    
    <s:form>
    
    <s:a href="ApplicantConsole.jsp">Applicant console</s:a>
    </s:form>

...
<table width="1403" height="1053" border="1">
  ...
  <tr>
    ...
    <p align="center" class="style1"> 
     <p align="center" style="color:#0000FF;font-size:24px"> Click button to view Applicants detail</p>
     <s:form action="hr_applicant_details.action">

	<s:submit value="Applicant Details"/>
	
	

</s:form>
<p>
    <s:form action="resumeshow.action"><s:submit value="View Resumes"></s:submit> </s:form>
    </p>

...
<table width="1403" height="1053" border="1">
  ...
  <tr>
    ...
    <p align="center" style="color:#0000FF;font-size:24px"> Wel Come!!!!</p>
<p align="center" style="color:#0000FF;font-size:24px"> You are Successfully Logged In...</p>
<p align="center" style="color:#0000FF;font-size:24px"> Click here to Apply for the vacancy....</p>
    
    <s:form action="pruthvi">
<s:submit value="View Vacancies"></s:submit>

</s:form>
    
    <p align="center" style="color:#0000FF;font-size:24px"> View Placement Schedule</p>
    
    <p align="center"><s:form action="hr_view_placement.action"><s:submit value="View Placement Schedule"></s:submit> </s:form> </p>
    <p align="center"><s:form action="hr_view_schedule.action"><s:submit value="View Interview Schedule"></s:submit> </s:form></p>
    </p></td>
    <td width="217">&nbsp;</td>
  </tr>
  <tr>

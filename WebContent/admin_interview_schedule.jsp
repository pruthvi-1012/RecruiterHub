...
<table width="1403" height="1053" border="1">
  ...
  <tr>
    ...
    <td><s:form action="admin_interviewdetail.action"><s:submit value="Interview Schedule"></s:submit> </s:form></td>
  </tr>
   <tr>

    <td><s:form action="admin_interviewedit.action"><s:submit value="Edit/Delete Interview Schedule"></s:submit> </s:form></td>
  </tr>
</table>

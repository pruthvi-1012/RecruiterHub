...
<table width="1403" height="1053" border="1">
  ...
  <tr>
    ...
    <p align="center" style="color:#0000FF;font-size:24px"> Interview Schedule</p>
    
    <table width="504" height="217" border="0" cellspacing="2">
  <tr>
    <td align="center"><s:form action="hr_create_schedule.action"><s:submit value="Create Schedule"></s:submit> </s:form> </td>
  </tr>
  <tr>
    <td align="center"><s:form action="hr_view_schedule.action"><s:submit value="View Schedule"></s:submit> </s:form></td>
  </tr>
  <tr><td align="center"><s:form action="hr_delete_schedule.action"><s:submit value="Delete Schedule"></s:submit> </s:form></td>
  </tr>

...
<table width="1403" height="1053" border="1">
  ...
  <tr>
    ...
    <p align="center" style="color:#0000FF;font-size:24px"> Delete Interview Details</p>
...
<s:iterator value="info" id="InterviewDetailsPojo" >
<tr>
<td><s:property value="vac_id"/> </td>
<td><s:property value="interview_date"/></td>
<td><s:property value="interview_time"/></td>
<td><s:property value="interview_place"/></td>
<td><s:property value="interview_department"/></td>
<td><s:property value="interviewer_name"/></td>
<td>
<s:param name="vac_id">
<s:property value="vac_id"/>   </s:param>    
<s:a href="vac_edit.jsp">Edit</s:a>
</td>

<td><s:url id="url" action="interview_delete.action">
<s:param name="vac_id">

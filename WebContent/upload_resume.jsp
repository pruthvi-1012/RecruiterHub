...
<table width="1403" height="1053" border="1">
  ...
  <tr>
    ...
    <td colspan="2"><table width="1103" border="1">
      <tr>
        <td width="215" height="23" align="center"><a href="file:///E|/EclipseProjects/Pruthvi/MyProject/WebContent/Home/home.jsp">Home</a></td>
        <td width="207" height="23" align="center"><a href="file:///E|/EclipseProjects/Pruthvi/MyProject/WebContent/login.jsp">Signin</a></td>
        <td width="219" height="23" align="center"><a href="file:///E|/EclipseProjects/Pruthvi/MyProject/WebContent/Applicant/ApplicantRegistration.jsp">Sign Up</a></td>
        <td width="215" height="23" align="center"><a href="file:///E|/EclipseProjects/Pruthvi/MyProject/WebContent/aboutus.jsp">About Us</a></td>
        <td width="213" height="23" align="center"><a href="file:///E|/EclipseProjects/Pruthvi/MyProject/WebContent/contactus.jsp">Contact Us</a></td>
      </tr>
    </table></td>
  </tr>
  <tr>
    ...
    <s:form action="uploadresume" method="post" enctype="multipart/form-data">
<tr><td>
<s:file name="resume" label="UPLOAD RESUME"></s:file>
</td></tr>
<tr><td>

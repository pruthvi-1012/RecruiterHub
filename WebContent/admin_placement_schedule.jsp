...
<table width="1403" height="1053" border="1">
  ...
  <tr>
    ...
    <td><s:form action="admin_placementshow.action"><s:submit value="Placement Schedule"></s:submit> </s:form></td>
  </tr>
   <tr>

    <td><s:form action="admin_placementedit.action"><s:submit value="Edit/Delete Placement Schedule"></s:submit> </s:form></td>
  </tr>
</table>
